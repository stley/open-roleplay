...
CMD:recargar(playerid){
    ...
    if(manoder){
        if(strfind(ObjetoInfo[manoder][NombreObjeto], "Beanbag", true) != -1){
            ...
            ApplyAnimation(playerid, "BUDDY", "buddy_reload", 4.1, false, true, true, false, 1, SYNC_NONE);
            update_manos(playerid);
            ...
            update_manos(playerid);
            ApplyAnimation(playerid, "PYTHON", "python_reload", 4.1, false, true, true, false, 1, SYNC_NONE);
