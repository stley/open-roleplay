...
public Wound_HandleDamage(playerid, issuerid, weaponid, bodypart, Float:amount){
    ...
    // ... your existing ammo type and damage calculation code stays the same ...
    if(weaponid == 0 &&  Datos[issuerid][jManoCant][0] == 0){
        ammo = 1;
        dmgtaken = amount;
    }
    ...
    // FIXED DAMAGE APPLICATION LOGIC:
    ...
    // FIXED: Handle regular damage (this was your broken condition)
    else {
        if(muerto[playerid] == 0){
